package com.github.tacticaldevmc.remotecore.remotecore.commands.base;
...
import com.github.tacticaldevmc.remotecore.remotecore.utils.exception.CoreCommandException;
import com.github.tacticaldevmc.remotecore.remotecore.utils.exception.CoreException;
import com.github.tacticaldevmc.remotecore.remotecore.utils.exception.UnkownPlayerException;
        ...
        try {
            ...
            if (!allowConsole) {
                if (sender instanceof ConsoleCommandSender) {
                    getSender().sendMessage(format(RemoteCoreSpigot.getInstance().getSettings().getPrefix() + "&cDit commando is alleen beschikbaar voor spelers!"));
                    return false;
                }
            }
            this.args = args;
            ...
            if (sub) {
                ...
                try {
                    ...
                    getSender().sendMessage(format(RemoteCoreSpigot.getInstance().getSettings().getPrefix() + "&cOnbekende speler!"));
                } catch (Exception e) {
                    getSender().sendMessage(format(RemoteCoreSpigot.getInstance().getSettings().getPrefix() + "&cEr ging iets fout!"));
        ...
        this.registerSub(new SubCommand("help", this.permission, "Help commando") {
            ...
            public void execute(String[] args) {
                try {
                    ...
                    sender.sendMessage(format(RemoteCoreSpigot.getInstance().getSettings().getPrefix() + "&cOnbekende pagina!"));
                }
            }
        });
    }
