package com.github.tacticaldevmc.remotecore.utils.namehistory;
...
public class NameHistory {
    ...
    private static NameHistory instance;

    public NameHistory() {
        setInstance(this);
    }

    public static NameHistory getInstance() {
        return instance;
    }

    public static void setInstance(NameHistory instance) {
        NameHistory.instance = instance;
    }
    ...
    public ArrayList<String> getNames(String playername) throws IOException {
        ...
        if (str == null) {
            LOGGER.log(Level.WARNING, "No name history was found!");
        }
