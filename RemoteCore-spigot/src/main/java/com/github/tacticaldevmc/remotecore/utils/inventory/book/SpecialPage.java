package com.github.tacticaldevmc.remotecore.utils.inventory.book;
...
public class SpecialPage implements IPage {
    ...
    public void addLine(ChatPieceHolder... pieces) {
        ...
        this.lines.add(new TextComponent(componentList.toArray(new BaseComponent[componentList.size()])));
    }
