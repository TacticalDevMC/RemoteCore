...
import com.github.tacticaldevmc.remotecore.commands.base.CommandModule;
import com.github.tacticaldevmc.remotecore.listeners.ListenerManager;
...
import com.github.tacticaldevmc.remotecore.settings.Settings;
...
import com.github.tacticaldevmc.remotecore.utils.mode.BuildMode;
...
public final class RemoteCoreSpigot extends JavaPlugin implements ICore {
    ...
    private final String authors = this.getDescription().getAuthors().toString().replace("[", "").replace("]", "");

    List<String> pluginsList = Arrays.asList("RemoteCore");

    private final List<IConf> configList = new ArrayList<>();
    ...
    public String getRemotePrefix() {
        return Colors.format("&7[&b&lR&3&lM&7] ");
    }
