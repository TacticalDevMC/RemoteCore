package com.github.tacticaldevmc.remotecore.remotecore.commands.main;
...
import com.github.tacticaldevmc.remotecore.remotecore.commands.main.sub.UserSubCommand;
    ...
    public void init() {
        this.registerSub(new SubCommand("reload", "remotecore.command.reload", "Reload command") {
            ...
            public void execute(String[] args) throws CoreException {
                ...
                getPlayer().sendMessage(format("&bRemoteCore TeamCity &3reloaded! &b" + RemoteCoreSpigot.getInstance().getDescription().getVersion()));
            }
        });
