...
import com.github.tacticaldevmc.remotecore.remotecore.utils.menu.interfaces.MenuUpdate;
...
public abstract class AbstractTMenu extends MenuHolder implements Menu {
    ...
    private final Map<ItemStack, MenuClick> clickableItems = new ConcurrentHashMap<>();
    ...
    public void openMenu(Player player, boolean ignoreCloseHandler) {
        ...
        }.runTaskLater(RemoteCoreSpigot.getInstance(), 1);
    }
