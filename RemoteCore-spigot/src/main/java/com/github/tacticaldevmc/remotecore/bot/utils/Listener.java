...
import com.github.tacticaldevmc.remotecore.bot.commands.base.CommandManager;
...
public class Listener extends ListenerAdapter {
    ...
    private final Map<Member, Long> noTranscriptMap = new HashMap<>();
    private final Map<Member, Long> transcriptMap = new HashMap<>();
