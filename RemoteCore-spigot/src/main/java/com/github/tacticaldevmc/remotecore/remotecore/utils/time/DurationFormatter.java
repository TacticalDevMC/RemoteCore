package com.github.tacticaldevmc.remotecore.remotecore.utils.time;
...
public enum DurationFormatter {
	...
	/**
	 * replaceColors a duration, in seconds
	 *
	 * @param seconds the duration
	 * @return the replaceColorted duration string
	 */
	...
	/**
	 * replaceColors a duration, in millis
	 *
	...
	/**
	 * replaceColors the duration between the current time and the given millis timestamp
	 *
	 * @param millisTimestamp the timestamp, in milliseconds
	 * @return the replaceColorted duration string
	 */
	public String replaceColorDateDiff(long millisTimestamp) {
